...
var MCP23017 = (function() {
  ...
  */
  MCP23017.prototype.pinMode = function (pin, direction) {
    ...
    this._setGpioDir(pin >= 8 ? pin - 8 : pin, direction, pin >= 8 ? REGISTER_GPIOB : REGISTER_GPIOA, pin >= 8 ? REGISTER_GPIOB_PULLUP : REGISTER_GPIOA_PULLUP);
  };
